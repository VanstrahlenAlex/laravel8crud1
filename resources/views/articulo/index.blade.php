...
@section('contenido')
<h1 class="text-center"> Articulos en bodega</h1>

<a href="articulos/create" class="btn btn-success">Añadir articulos</a>
<a href="categoria" class="btn btn-success">Ver categorias</a>
